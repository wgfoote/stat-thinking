...
There are many criteria we could choose. We would typically choose mean absolute deviations of the data from the mean or the sum of squared deviations from the mean. The graph depicts the sum of squared deviations. Use of such a criterion allows us a clear and in this case unique calculation of the best linear estimator for the mean.
...
A bit of calculus confirms the brute force choice of mean that minimizes the sum of squared deivations about the mean. Hover over the graph and brush over the area around the red dot to zoom in.
...
$$
m = \frac{\Sigma_{i=1}^5 Y_i}{N}
$$

This is none other than the arithmetic mean. We will perform a very similar procedure to get the sample means of the y-intercept $b_0$ and slope $b_1$ of the relationship
