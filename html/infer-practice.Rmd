...
x_bar <- 60;  n <- 100 ; p_bar <- x_bar / n ; sig_p_bar <- sqrt(p*(1-p)/n) ; upper <- 0.025; z <- qnorm(1-upper, 0, 1)
...
The population variance of $\bar X / n = \bar p$ (standard deviatyion squared) is then
